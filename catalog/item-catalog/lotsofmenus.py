...
menuItem2 = MenuItem(user_id=1, name="Peking Duck",
                     ...
                     front of the diners by the cook""", price="$25",
...
menuItem2 = MenuItem(user_id=1, name="Chinese Dumplings",
                     ...
                     wrapped into a piece of dough skin. The skin can be either
...
menuItem3 = MenuItem(user_id=1, name="Honey Boba Shaved Snow",
                     ...
                     mochi""", price="$4.50", course="Dessert",
...
menuItem4 = MenuItem(user_id=1, name="Tandoori Chicken",
                     ...
                     with a spicy mix(chilli, tamarind among others) and slow
                     cooked in a cylindrical clay or metal oven which gets its
...
menuItem2 = MenuItem(user_id=1, name="Cachapa",
                     ...
                     pancake; usually stuffed with queso telita or queso de
                     mano, and possibly lechon. """,
                     price="$7.99", course="Entree", restaurant=restaurant1)
